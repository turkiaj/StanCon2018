...
top_neg_edges <- head(alledges[order(alledges$weight)], 10)
top_pos_edges <- head(alledges[order(-alledges$weight)], 10)
top_pers_edges <- head(alledges[order(-alledges$b_sigma)], 10)
